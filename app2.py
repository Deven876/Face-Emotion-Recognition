...
# Loading pre-trained parameters for the cascade classifier
try:
    face_classifier = cv2.CascadeClassifier('https://drive.google.com/file/d/1KgHsNkJGk2CcJ5Qe6NZ4n-0JApCQpkMM/view?usp=sharing') # Face Detection
    classifier =load_model('https://drive.google.com/file/d/1-OPpnwapt-x2-OKbv5Cae69zJS481AY2/view?usp=sharing')  #Load model
...
class VideoTransformer(VideoTransformerBase):
    ...
    def transform(self, frame):
        ...
        face_detect = cv2.CascadeClassifier('https://drive.google.com/file/d/1KgHsNkJGk2CcJ5Qe6NZ4n-0JApCQpkMM/view?usp=sharing')
...
if __name__ == "__main__":
    main()') # Face Detection
    classifier =load_model('https://github.com/Deven876/Face-Emotion-Recognition/blob/main/FER_model.h5')  #Load model
    emotion_labels = ['Angry','Disgust','Fear','Happy','Neutral', 'Sad', 'Surprise']  # Emotion that will be predicted
except Exception:
    st.write("Error loading cascade classifiers")
